...
For example, if the current block height was 5000, you'd add 250,000 for the stake withdrawl cooldown period, plus an additional 30 blocks to allow for chain processing delays. Therefore the `stake-release-height` = `5000 + 250000 + 30` or `255030`.
